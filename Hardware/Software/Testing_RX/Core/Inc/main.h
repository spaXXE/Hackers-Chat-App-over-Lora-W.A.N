...
#define LORA_NCS_Pin GPIO_PIN_4
#define LORA_NCS_GPIO_Port GPIOA
#define LORA_SCK_Pin GPIO_PIN_5
#define LORA_SCK_GPIO_Port GPIOA
#define LORA_CIPO_Pin GPIO_PIN_6
#define LORA_CIPO_GPIO_Port GPIOA
#define LORA_COPI_Pin GPIO_PIN_7
#define LORA_COPI_GPIO_Port GPIOA
